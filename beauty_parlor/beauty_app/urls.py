...
from .views.service_views import (
    ServiceListView, ServiceDetailView, ServiceCreateView, ServiceUpdateView, check_service_discount,
    ServiceImageDeleteView, PublicLandingView
...
from .views.therapist_views import (
    TherapistListView, TherapistAssignmentView, RemoveTherapistAssignmentView, booking_calendar_therapist_view,
    therapist_detail_api,
...
urlpatterns = [
    ...
    path('services/<int:service_id>/images/<int:image_id>/delete/', ServiceImageDeleteView.as_view(),
    ...
    path('request-booking/confirmation/<str:request_id>/', PublicBookingRequestConfirmationView.as_view(),
         name='public_booking_request_confirmation'),
    ...
    path('booking-requests/<int:pk>/approve/', StaffBookingRequestApproveView.as_view(),
         name='staff_booking_request_approve'),
    path('booking-requests/<int:pk>/reject/', StaffBookingRequestRejectView.as_view(),
         name='staff_booking_request_reject'),

    path('bookings/<int:booking_id>/assign-therapist/', TherapistAssignmentView.as_view(), name='assign_therapist'),
    path('booking/therapist-assignment/<int:pk>/remove/', RemoveTherapistAssignmentView.as_view(),
         name='remove_therapist_assignment'),
    ...
    path('calendar/therapist/public/', public_booking_calendar_therapist_view,
         name='public_booking_calendar_therapist'),

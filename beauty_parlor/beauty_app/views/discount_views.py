...
class DiscountListView(LoginRequiredMixin, AdminRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        return Discount.objects.select_related('service').all().order_by(
            '-start_date', '-end_date'
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        services_with_discounts = Discount.objects.filter(
    ...
    def form_valid(self, form):
        ...
        if discounts_created == 1:
            messages.success(self.request,
                             f"Discount '{discount_name}' created successfully for '{selected_services[0].name}'.")
        else:
            messages.success(self.request,
                             f"Discount '{discount_name}' created successfully for {discounts_created} services.")

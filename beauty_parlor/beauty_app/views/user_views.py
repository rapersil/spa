...
class StaffDetailView(LoginRequiredMixin, AdminRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['activity_counts'] = {
            ...
            'bookings_updated': Booking.objects.filter(updated_by=staff_member).exclude(
                created_by=staff_member).count(),
        ...
        context['time_based_activity'] = {
            ...
            'sales_this_month': Sale.objects.filter(created_by=staff_member,
                                                    payment_date__date__gte=month_start).count(),
        }

...
from .models import CustomUser, Customer, Service, Booking, Discount, Sale, ServiceImage, AdditionalService, Audit, \
    BookingRequest, ServiceTherapist, BookingTherapistAssignment
...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': (
            'first_name', 'last_name', 'email', 'phone_number', 'profile_picture', 'password_change_required')}),
        ('Permissions', {'fields': (
            'user_type', 'primary_service', 'is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions')}),
...
class DiscountAdmin(admin.ModelAdmin):
    list_display = (
        'discount_id', 'name', 'service', 'percentage', 'start_date', 'end_date', 'discount_status', 'created_by')
...
class SaleAdmin(admin.ModelAdmin):
    list_display = (
        'sale_id', 'receipt_number', 'customer_name', 'service_name', 'payment_date', 'payment_amount',
        'payment_method',
        'created_by')
